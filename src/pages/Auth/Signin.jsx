...
import { validateName, validatePassword ,validateNic,validateEmail} from "../../Validator";
...
const SuperAdminLogin = () => {
  const [formData,setFormData] = useState({email:"", name:"", lname:"",nic:"",password:"" ,securityKey:""});
  const [errors,setErrors] = useState({email:"", name:"", nic:"",password:"",check:false });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
        if (validateName(formData.name) !== "valid" || validateNic(formData.nic) !== "valid" || validatePassword(formData.password)!== "valid" || validatePassword(formData.email)!== "valid" || !isChecked) {
          setErrors({
            name: validateName(formData.name) !== "valid" ? validateName(formData.name) : "" ,
            email: validateEmail(formData.email) !== "valid" ? validateEmail(formData.email) : "" ,
            nic: validateNic(formData.nic) !== "valid" ? validateNic(formData.nic) : "" ,
